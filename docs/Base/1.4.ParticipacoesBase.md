...
| [ Yasmim Rosa](https://github.com/yaskisoba) | 1. Participação na realização da Design Sprint;<br> | Excelente | Registro no versionamento do documento de [Design Sprint](Base/1.1.DesignSprint.md) e registro da participação presente na [Ata de reunião 02](Atas/2.2.Ata02.md).|
| [Matheus Rodrigues](https://github.com/mrodrigues14) | 1. Organização e apoio na realização da Design Sprint;<br> 2. Contribuição na documentação e revisão dos artefatos. 3. Inicio da prototipação | Excelente | Registro no versionamento do documento de [Design Sprint](Base/1.1.DesignSprint.md) e registro da participação presente na [Ata de reunião 02](Atas/2.2.Ata02.md).|
| [Daniel Coimbra](https://github.com/DanielCoimbra) | 1. Participação da Design Sprint;<br>  | Excelente | Registro da participação presente na [Ata de reunião 02](Atas/2.2.Ata02.md).|
...
| [Yasmim Rosa](https://github.com/yaskisoba) | 1. Desenvolvimento de Rich Picture individual;<br> 2. Criação do Plano de Tempo;<br> 3. Criação do Plano de Custo;<br> 4. Criação de Plano de Risco | Excelente | Registro nos versionamentos dos documentos de [Rich Picture](Base/1.2.4.RichPicture.md), [Plano de Tempo](Base/1.2.5.1.PlanoTempo.md), [Plano de Custo](Base/1.2.6.3.PlanoDeCusto.md), [Plano de Risco](Base/1.2.6.2.PlanoDeRisco.md).|
| [Matheus Rodrigues](https://github.com/mrodrigues14) | 1. Desenvolvimento de Rich Picture individual;<br> 2. Criação do 5W2H;<br> 3. Revisões e ajustes na documentação dos artefatos. | Excelente | Registro nos versionamentos dos documentos de [Rich Picture](Base/1.2.4.RichPicture.md), [5W2H](Base/1.2.1.5W2H.md).|
| [Daniel Coimbra](https://github.com/DanielCoimbra) | 1. Desenvolvimento de Rich Picture individual;<br> 2. Revisões e ajustes no diagrama de causa e efeito. | Excelente | Registro nos versionamentos dos documentos de [Rich Picture](Base/1.2.4.RichPicture.md), [Diagrama causa e efeito](Base/1.2.3.DiagramaCausaEfeito.md).|
...
[Yasmim Rosa](https://github.com/yaskisoba) | 1. Criação da raia de Gerenciamento de Tarefas/Criação de To-Do <br/>| Excelente | Registro nos versionamentos do documento de [1.3 Modelagem BPMN](Base/1.3.ModelagemBPMN.md) na Equipe B.
| [Matheus Rodrigues](https://github.com/mrodrigues14) | 1. Participação na mesclagem dos BPMNs desenvolvidos pelas equipes e refinamento; | Excelente | Registro nos versionamentos do documento de [1.3 Modelagem BPMN](Base/1.3.ModelagemBPMN.md).|
| [Daniel Coimbra](https://github.com/DanielCoimbra) | 1. Desenvolvimento do BPMN equipe A; | Excelente | Finalização e upload do arquivo .png ao repositório [1.3 Modelagem BPMN](Base/1.3.ModelagemBPMN.md).|
